...
//服务器异步通知页面路径
$notify_url = (@$_POST['notify_url']!='')?$_POST['notify_url']:'http://'.$_SERVER['SERVER_NAME'].'/'.$config['notify_url'];
//需http://格式的完整路径，不能加?id=123这类自定义参数

//页面跳转同步通知页面路径
$return_url = (@$_POST['return_url']!='')?$_POST['return_url']:'http://'.$_SERVER['SERVER_NAME'].'/'.$config['return_url'];
...
//file_put_contents('./temp/test.txt',$html_text);
//exit;
