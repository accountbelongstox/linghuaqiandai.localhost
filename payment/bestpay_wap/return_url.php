...
if($_POST['UPTRANSEQ']!=null){
			...
			if($SIGN==$md5_originalsign){
				...
				header('location:../../index.php?cloud=index.financial_center');exit;
...
<html>
    ...
    <body>
		<div align="center">'.$language['pay'].$language['fail'].'<a href=/index.php?cloud=index.recharge_log>'.$language['return'].'</a></div>
    </body>
</html>';			
			}
