...
$notify_url = 'http://'.$_SERVER['SERVER_NAME'].'/'.$config['notify_url'];
...
if($r['return_url']==''){$return_url='../../index.php?cloud=index.financial_center';}else{$return_url=de_safe_str($r['return_url']);}
//==================================================================================================================配置支付成功后的返回链接 end 
?>
