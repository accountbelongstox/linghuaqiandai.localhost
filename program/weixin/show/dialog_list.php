...
<table class=content_table cellpadding='0' cellspacing='0'><tr><td class=td_1>&nbsp;</td><td class=td_2>&nbsp;</td><td class=td_3>&nbsp;</td></tr><tr><td class=td_4>&nbsp;</td><td class=td_5>".str_replace("\r\n",'<br />',$v['content'])."</td><td class=td_6>&nbsp;</td></tr><tr><td class=td_7>&nbsp;</td><td class=td_8>&nbsp;</td><td class=td_9>&nbsp;</td></tr></table>	
	...
	<td class=act_td>
	<a href='index.php?cloud=".$class.".dialog&wid=".$wid."&openid=".$v['from']."' class='edit'>".self::$language['dialog']."</span>".$new."<span class=b_end>&nbsp;</span></a>
...
echo ' <div id="user_position_reset" style="display:none;"><a href="index.php"><span id=user_position_icon>&nbsp;</span>'.self::$config['web']['name'].'</a><a href="index.php?cloud=index.user">'.self::$language['user_center'].'</a><a href="index.php?cloud=weixin.account_list">'.self::$language['pages']['weixin.account_list']['name'].'</a><a href="index.php?cloud=weixin.account_list&wid='.$wid.'">'.$w_name.'</a><span class=text>'.self::$language['pages']['weixin.dialog_list']['name'].'</span></div>';	
