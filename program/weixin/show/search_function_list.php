...
$sql="select * from ".self::$table_pre."search_function";
...
$limit=" limit ".($_GET['current_page']-1)*$page_size.",".$page_size;
	...
	$sum_sql=str_replace("_search_function and","_search_function where",$sum_sql);
	//echo $sum_sql;
	$r=$pdo->query($sum_sql,2)->fetch(2);
	$sum=$r['c'];
$sql=$sql.$where.$order.$limit;
$sql=str_replace("_search_function and","_search_function where",$sql);
//echo($sql);
//exit();
$r=$pdo->query($sql,2);
$list='';
