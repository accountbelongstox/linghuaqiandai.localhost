...
if($module['data']['username']!=$_SESSION['user']['username']){echo 'is not your account';return false;}
...
echo ' <div id="user_position_reset" style="display:none;"><a href="index.php"><span id=user_position_icon>&nbsp;</span>'.self::$config['web']['name'].'</a><a href="index.php?cloud=index.user">'.self::$language['user_center'].'</a><a href="index.php?cloud=weixin.account_list">'.self::$language['pages']['weixin.account_list']['name'].'</a><a href="index.php?cloud=weixin.account_list&wid='.$module['data']['wid'].'">'.$module['data']['name'].'</a><span class=text>'.self::$language['pages']['weixin.account_edit']['name'].'</span></div>';	
