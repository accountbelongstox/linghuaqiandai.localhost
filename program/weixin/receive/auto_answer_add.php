...
switch($type){
	case 'text':
		...
		$sql="insert into ".self::$table_pre."auto_answer (`wid`,`key`,`input_type`,`output_type`,`time`,`".$type."`,`author`) values ('".$wid."','".$key."','".$type."','text','".$time."','".$v."','".$_SESSION['user']['username']."')";
		break;	
	case 'image':
		...
		$sql="insert into ".self::$table_pre."auto_answer (`wid`,`key`,`input_type`,`output_type`,`time`,`".$type."`,`author`) values ('".$wid."','".$key."','".$type."','news','".$time."','".$v."','".$_SESSION['user']['username']."')";
		break;	
	case 'voice':
	...
	case 'single_news':
		...
		if(self::$config['program']['imageMark']){$image->addMark($path);}
		$sql="insert into ".self::$table_pre."auto_answer (`wid`,`key`,`input_type`,`output_type`,`time`,`author`) values ('".$wid."','".$key."','".$type."','news','".$time."','".$_SESSION['user']['username']."')";
		break;	
	case 'news':
		$sql="insert into ".self::$table_pre."auto_answer (`wid`,`key`,`input_type`,`output_type`,`time`,`author`) values ('".$wid."','".$key."','".$type."','news','".$time."','".$_SESSION['user']['username']."')";
		break;	
