...
$null_able=array('area','if_email','if_weixin','keyword','qr_code','qr_code_file','receive_if_email','no_keyword_if_email','no_search_if_email','receive_if_weixin','no_keyword_if_weixin','no_search_if_weixin','smtp_password','smtp_account','smtp_url','AppId','AppSecret','open_search');
...
if($r['username']!=$_SESSION['user']['username']){exit("{'state':'fail','info':'<span class=fail>is not your account</span>'}");}
