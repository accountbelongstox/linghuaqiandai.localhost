...
class weixin{
	...
	function weixin_receive_to_location($data){
		...
		return '<a href="http://www.cloud.com/index.php?cloud=server.map&x='.$data['Location_X'].'&y='.$data['Location_Y'].'&zoom='.$data['Scale'].'" target="_blank" class=receive_location ><img src='.$url.' /></a>';
	}
