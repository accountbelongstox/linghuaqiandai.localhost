...
if($axis['username']!=$_SESSION['user']['username']){echo 'axis_id power err';return false;}


$module['cloud_table_name']=$axis['name'].' '.self::$language['functions'][str_replace("::",".",$method)]['description'];
...
foreach($r as $v){
  ...
  <td class=operation_td><a href=/index.php?cloud=axis.content&axis_id=".$_GET['axis_id']."&id=".$v['id']." class='edit set_content'>".self::$language['edit']."</a><a href='#' onclick='return del(".$v['id'].")'  class='del'>".self::$language['del']."</a> <span id=act_state_".$v['id']." class='act_state'></span></td>
</tr>
";	
}
