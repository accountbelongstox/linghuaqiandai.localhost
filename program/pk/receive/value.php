...
if($r['username']!=$_SESSION['user']['username']){exit("{'state':'fail','info':'<span class=fail>object_id power err</span>'}");}
$pk_id=$r['pk_id'];
...
if($r['username']!=$_SESSION['user']['username']){exit("{'state':'fail','info':'<span class=fail>item_id power err</span>'}");}
