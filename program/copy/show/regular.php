...
if(intval(@$_GET['id'])!=0){
	...
	echo '<div  style="display:none;" id="user_position_append"><a href="/index.php?cloud=copy.regular">'.self::$language['pages']['copy.regular']['name'].'</a><span class=text>'.$_GET['id'].'</span></div>';
}
...
foreach($r as $v){
  ...
  <a href='/index.php?cloud=copy.regular_edit&id=".$v['id']."' class='edit'>".self::$language['edit']."</a> 
  <a href='/index.php?cloud=copy.table&id=".$v['id']."' class='table'>".self::$language['table_02']."</a> 
  <a href='/index.php?cloud=copy.field&id=".$v['id']."' class='edit'>".self::$language['field']."</a> 
  <a href='/index.php?cloud=copy.task_list&id=".$v['id']."' class='edit'>".self::$language['task_list']."</a> 
  <a href='/index.php?cloud=copy.task&regular_id=".$v['id']."' class='edit'>".self::$language['exe_copy']."</a> 
