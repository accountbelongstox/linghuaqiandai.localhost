...
if($regular_id!=0){
	...
	echo '<div  style="display:none;" id="user_position_append"><a href="/index.php?cloud=copy.regular&id='.$id.'">'.$r['name'].'</a><span class=text>'.self::$language['pages']['copy.task']['name'].'</span></div>';
