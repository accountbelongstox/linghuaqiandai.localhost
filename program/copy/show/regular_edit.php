...
echo '<div  style="display:none;" id="user_position_append"><a href="/index.php?cloud=copy.regular&id='.$id.'">'.$module['data']['name'].'</a><span class=text>'.self::$language['pages']['copy.regular']['name'].'</span></div>';
