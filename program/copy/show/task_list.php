...
echo '<div  style="display:none;" id="user_position_append"><a href="/index.php?cloud=copy.regular&id='.$id.'">'.$r['name'].'</a><span class=text>'.self::$language['pages']['copy.task_list']['name'].'</span></div>';
...
foreach($r as $v){
  ...
  <td><select id='data_state_".$v['id']."' name='data_state_".$v['id']."' cloud_value='".$v['state']."' class=data_state>".get_task_state_option(self::$language['task_state'])."</select></td>
  ...
  <a href='/index.php?cloud=copy.task&id=".$v['id']."' target=_blank class='submit'>".self::$language['open_copy_text'][$v['state']]."</a> 
