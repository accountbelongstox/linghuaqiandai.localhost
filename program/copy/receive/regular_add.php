...
if($pdo->exec($sql)){
	...
	exit("{'state':'success','info':'<span class=success>".self::$language['success']."</span><script>window.location.href='index.php?cloud=".self::$config['class_name'].".regular&id=".$insret_id."';</script>'}");
}else{
