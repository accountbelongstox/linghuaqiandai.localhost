...
$module['action_url']="/receive.php?target=index::edit_page_layout&act=update_attribute&old_module=article.show_list".$_GET['args'].'&url='.$_GET['url'].'&new_module=article.show_list';
