cloud_sql_startDROP TABLE IF EXISTS `cloud_article_article`;m;o;n;

CREATE TABLE `cloud_article_article` (
...
INSERT INTO `cloud_article_article` (`id`,`title`,`content`,`src`,`type`,`sequence`,`visible`,`editor`,`time`,`visit`,`link`,`tag`) VALUES
...
DROP TABLE IF EXISTS `cloud_article_article_type`;m;o;n;

CREATE TABLE `cloud_article_article_type` (
...
INSERT INTO `cloud_article_article_type` (`id`,`name`,`parent`,`sequence`,`visible`) VALUES
('35','公司新闻','73','99','1'),
('68','国内新闻','65','0','0'),
('67','全球动态','65','0','1'),
('65','行业资讯','73','0','1'),
