...
foreach($r as $v){
	$v=de_safe_str($v);
	$list.="<tr id='tr_".$v['id']."'>
	<td><input type='text' name='title_".$v['id']."' id='title_".$v['id']."' value='".$v['title']."'  class='title' /><br /></td>
  <td><input type='checkbox' name='email_".$v['id']."' id='email_".$v['id']."'  class='email' value=".$v['email']." /></td>
  ...
  <td class=operation_td><a href='#' onclick='return update(".$v['id'].")'  class='submit'>".self::$language['submit']."</a> <a href='index.php?cloud=".$class.".content&id=".$v['id']."' target=_blank  class='view'>".self::$language['view']."</a> <span id=state_".$v['id']." class='state'></span></td>
</tr>
";	
}
