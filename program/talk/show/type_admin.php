...
<a href='/index.php?cloud=talk.set_group&id=".$v['id']."&act=read_power'  class='read_power'>".$language['read_power']."</a>
			  <a href='/index.php?cloud=talk.set_group&id=".$v['id']."&act=title_power'  class='title_power'>".$language['title_power']."</a>
			  <a href='/index.php?cloud=talk.set_group&id=".$v['id']."&act=content_power'  class='content_power'>".$language['content_power']."</a>
