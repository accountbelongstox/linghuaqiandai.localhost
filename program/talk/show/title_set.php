...
$all=array('title'=>self::$language['title'],'username'=>self::$language['author'],'time'=>self::$language['title_time'],'contents'=>self::$language['content_sum'],'visit'=>self::$language['visit_count']);
$module['field_checkbox']=get_field_checkbox($attribute['field'],$all);
$module['action_url']="/receive.php?target=index::edit_page_layout&act=update_attribute&old_module=talk.title".$_GET['args'].'&url='.$_GET['url'].'&new_module=talk.title';
