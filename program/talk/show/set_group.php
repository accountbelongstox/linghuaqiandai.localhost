...
echo ' <div id="user_position_reset" style="display:none;"><a href="index.php"><span id=user_position_icon>&nbsp;</span>'.self::$config['web']['name'].'</a><a href="index.php?cloud=index.user">'.self::$language['user_center'].'</a><a href="index.php?cloud=form.table_admin">'.self::$language['program_name'].'</a><a href="index.php?cloud=talk.type_admin&id='.@$_GET['id'].'">'.$r['name'].'</a><span class=text>'.self::$language[$_GET['act']].self::$language['power'].'</span></div>';	
