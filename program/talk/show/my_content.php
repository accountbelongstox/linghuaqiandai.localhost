...
$where=" where `username`='".$_SESSION['user']['username']."' and `for`=0";
...
foreach($r as $v){
	...
	$list.="<tr id='tr_".$v['id']."'>
	<td><a href='".self::get_content_link($pdo,$v['id'],$r2['id'],$module_config)."' target=_blank class=title>".$r2['title']."</a><div class=content>".$v['content']."</div></td>
  ...
  <td class=operation_td><a href='index.php?cloud=".$class.".content_edit&id=".$v['id']."' target=_blank  class='edit'>".self::$language['edit']."</a> <a href='#' onclick='return del(".$v['id'].")'  class='del'>".self::$language['del']."</a><span id=state_".$v['id']." class='state'></span></td>
</tr>
";	
}
