...
$sql="select `id`,`title` from ".self::$table_pre."img";
$where="";
...
$module['action_url']="/receive.php?target=index::edit_page_layout&act=update_attribute&old_module=image.show_content".$_GET['args'].'&url='.$_GET['url'].'&new_module=image.show_content';
