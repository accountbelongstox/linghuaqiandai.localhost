cloud_sql_startDROP TABLE IF EXISTS `cloud_image_img`;m;o;n;
CREATE TABLE `cloud_image_img` (
...
INSERT INTO `cloud_image_img` (`id`,`title`,`content`,`src`,`type`,`sequence`,`visible`,`editor`,`time`,`visit`,`link`) VALUES
...
('213','动点','','2014_02/27/1393471714_0_1598.png','54','0','1','4','1393471731','7','http://www.cloud.com/'),
...
DROP TABLE IF EXISTS `cloud_image_img_type`;m;o;n;
CREATE TABLE `cloud_image_img_type` (
...
INSERT INTO `cloud_image_img_type` (`id`,`name`,`parent`,`sequence`,`visible`,`remark`) VALUES
('35','服务案例','0','0','1',''),
('54','企业站','35','0','1','<div>
	&nbsp;美观时尚，装点家居，创意礼品。<br />
