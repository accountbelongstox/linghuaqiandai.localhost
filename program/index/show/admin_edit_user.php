...
$module['module_name']=str_replace("::","_",$method);
	...
	$module['manager']=self::get_manager($pdo,$module['id'],$module['group'],$module['manager'])." <a href='index.php?cloud=index.edit_user_group&id=".$module['id']."&group=".$module['group']."'>".self::$language['change']."</a>";
...
require($t_path);
	...
	$html4Upfile->echo_input("icon",'100%','/upload/'.$class.'/user_icon/','true','false','jpg|gif|png|jpeg','500','5');
	echo '</span>';
	echo "<span id='license_photo_front_ele'>";
	$html4Upfile->echo_input("license_photo_front",'100%','/upload/index/user_license_photo_front/','true','false','jpg|gif|png|jpeg','500','5');
	echo '</span>';
	echo "<span id='license_photo_reverse_ele'>";
	$html4Upfile->echo_input("license_photo_reverse",'100%','/upload/index/user_license_photo_reverse/','true','false','jpg|gif|png|jpeg','500','5');
	echo '</span>';
	echo "<span id='weixincode_ele'>";
	$html4Upfile->echo_input("weixincode",'100%','/upload/index/user_weixincode/','true','false','jpg|gif|png|jpeg','500','5');
	echo '</span>';
