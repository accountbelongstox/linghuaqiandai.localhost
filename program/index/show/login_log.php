...
if($_GET['id']==0){$_GET['id']=$_SESSION['user']['id'];}
if($this->check_user_power($pdo,$_GET['id']) || $_SESSION['user']['id']==$_GET['id']){
...
if($_GET['id']!=$_SESSION['user']['id']){$module['username_display']='block';}else{$module['username_display']='none';}
