...
$module['data']=de_safe_str(@file_get_contents('./program/index/right_buttons_'.$type.'_data.txt'));
...
$t_path='./templates/'.$m_require_login.'/'.$class.'/'.self::$config['program']['template_'.$m_require_login].'/'.$_COOKIE['cloud_device'].'/'.str_replace($class."::","",$method).'_'.$type.'.php';
