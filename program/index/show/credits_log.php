...
$sql="select * from ".$pdo->index_pre."credits  where `username`='".$_SESSION['user']['username']."'";

$where="";
if(@$_GET['type']!=''){$where=" and `type`='".safe_str($_GET['type'])."'";}
if($_GET['search']!=''){$where=" and (`reason` like '%".$_GET['search']."%')";}
if(@$_GET['order']==''){
