...
if(self::$config['web']['phone_show_cloud_bottom']){$module['phone_show_cloud_bottom']=1;}else{$module['phone_show_cloud_bottom']=0;}
if(self::$config['web']['request_geolocation']){$module['request_geolocation']=1;}else{$module['request_geolocation']=0;}
