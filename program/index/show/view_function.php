<?php
		...
		$module['groups']=index::get_groups($pdo,0,"index.php?cloud=index.view_function&program=".$program."&id=");
		...
		if($id==0){
			...
			header("location:index.php?cloud=index.view_function&id=".$r['id']);	
		}
