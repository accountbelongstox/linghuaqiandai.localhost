...
if($act=='email'){
	...
	$module['task_info']=self::$language['send_mail_task_being_performed'];	
}
...
$_SESSION['token'][$method]=get_random(8);$module['action_url']="/receive.php?token=".$_SESSION['token'][$method]."&target=".$method.'&act='.$act;
