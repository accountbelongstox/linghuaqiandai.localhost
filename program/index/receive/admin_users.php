...
<form id="cloud_form" name="cloud_form" method="POST" action="./index.php?cloud=index.send_wxmoney"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
		}
...
<form id="cloud_form" name="cloud_form" method="POST" action="./index.php?cloud=index.site_msg"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
			}
		}
...
<form id="cloud_form" name="cloud_form" method="POST" action="./index.php?cloud=index.email_msg"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
			}
		}
...
<form id="cloud_form" name="cloud_form" method="POST" action="./index.php?cloud=index.phone_msg"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
			}
		}
...
<form id="cloud_form" name="cloud_form" method="POST" action="index.php?cloud=index.edit_user_group"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
			}
		}
...
<form id="cloud_form" name="cloud_form" method="POST" action="index.php?cloud=index.edit_user_group&group='.$_GET['group'].'"><input type="text" name="data" id="data" value="'.$list.'" /></form>
';
			}
		}
