...
if($_POST['css_pc_bg']!=''){
	if(file_exists('./temp/'.$_POST['css_pc_bg'])){
		...
		$path='./upload/form/img/'.$_POST['css_pc_bg'];
		@safe_unlink('./upload/form/img/'.$r['css_pc_bg']);
...
if($_POST['css_phone_bg']!=''){
	if(file_exists('./temp/'.$_POST['css_phone_bg'])){
		get_date_dir('./upload/form/img/');
		$path='./upload/form/img/'.$_POST['css_phone_bg'];
		@safe_unlink('./upload/form/img/'.$r['css_phone_bg']);
