...
$module['cloud_table_name'].='('.$module['data']['description'].')';
if($module['data']['css_pc_bg']!=''){$module['data']['css_pc_bg']='<img class=css_pc_bg src="/upload/form/img/'.$module['data']['css_pc_bg'].'" />';}
if($module['data']['css_phone_bg']!=''){$module['data']['css_phone_bg']='<img class=css_phone_bg src="/upload/form/img/'.$module['data']['css_phone_bg'].'" />';}
