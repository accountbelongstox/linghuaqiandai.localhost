...
$all=array('title'=>self::$language['title']);
$module['field_checkbox']=get_field_checkbox($attribute['field'],$all);
$module['action_url']="/receive.php?target=index::edit_page_layout&act=update_attribute&old_module=diypage.show_list".$_GET['args'].'&url='.$_GET['url'].'&new_module=diypage.show_list';
...
$module['data_src_option']='<option value=auto>auto</option>'.$this->get_parent($pdo);
