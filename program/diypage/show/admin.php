...
$sql="select `id`,`title`,`type`,`editor`,`sequence`,`visible`,`time`,`visit` from ".self::$table_pre."page";
...
$limit=" limit ".($_GET['current_page']-1)*$page_size.",".$page_size;
	$sum_sql=$sql.$where;
	$sum_sql=str_replace(" `id`,`title`,`type`,`editor`,`sequence`,`visible`,`time`,`visit` "," count(id) as c ",$sum_sql);
...
foreach($r as $v){
  ...
  <td class=operation_td><a href='index.php?cloud=".$class.".show&id=".$v['id']."' target=_blank  class='view'>".self::$language['view']."</a> <a href='#' onclick='return update(".$v['id'].")'  class='submit'>".self::$language['submit']."</a> <a href='index.php?cloud=".$class.".edit&id=".$v['id']."' target=_blank class='edit'>".self::$language['edit']."</a> <a href='#' onclick='return del(".$v['id'].")'  class='del'>".self::$language['del']."</a> <span id=state_".$v['id']." class='state'></span></td>
</tr>
";	
}
