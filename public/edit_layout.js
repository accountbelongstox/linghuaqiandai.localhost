$(document).ready(function(){
	...
	$(".module_del").click(function(){
		...
		$(this).parent().parent().parent().attr('class','cloud_module_div_deleted');
		return false;	
	});
	...
	$(".add_module").click(function(){
		...
		url='index.php?cloud=index.edit_page_layout_add_module&url='+page+'&area='+area+'&params='+params;
		//alert(url);
		window.location.href=url;	
		return false;
	});	
	...
	$("#composing_selection a").click(function(){
		...
		$("#set_composing_state").load("/receive.php?target=index::edit_page_layout&act=switch_composing&layout=full&cloud="+get_param('cloud')+'&to='+css,function(){
