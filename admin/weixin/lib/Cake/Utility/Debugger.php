	...
	public static function trace($options = array()) {
		...
		for ($i = $options['start']; $i < $count && $i < $options['depth']; $i++) {
			...
			if ($options['format'] === 'points' && $trace['file'] !== '[internal]') {
				...
				$back[] = String_new::insert($tpl, $trace, array('before' => '{:', 'after' => '}'));
			}
		}
 ...
 *
 * Where $data is an array of strings that use String_new::insert() variable
	...
	public function outputError($data) {
		...
		if (isset($tpl['links'])) {
			foreach ($tpl['links'] as $key => $val) {
				$links[$key] = String_new::insert($val, $data, $insertOpts);
			}
		}
		...
		foreach ($infoData as $key => $value) {
			...
			$info .= String_new::insert($tpl[$key], array($key => $value) + $data, $insertOpts);
		}
		$links = implode(' ', $links);
		...
		echo String_new::insert($tpl['error'], compact('links', 'info') + $data, $insertOpts);
	}
