...
<?php $this->start('sidebar'); ?>
	<?php foreach ($vmenu['menu'] as $key => $vals): ?>
		<?php
...
<div class="main-container" id="main-container">
 ...
 <div class="mtm copyright text-center">©2017 <a href="javascript:;" target="_blank">好好数据微信管理</a>&nbsp;<?php echo $version; ?></div>
 <!-- /.main-container
</div><!-- /.main-container -->