	...
	<div class="col-xs-12">
		<div class="table-responsive">
			<table id="sample-table-1" class="table table-striped table-bordered table-hover account">
				...
				<tbody>
					<?php if (is_array($data['datalist'])): ?>
						<?php foreach ($data['datalist'] as $key => $vals): ?>
							<tr>
								<td style="text-align:center;">
									<?= $this->Html->image($vals['WxWebchat']['FIcon'], array('fullBase' => true, 'width' => "50px", 'height' => "50px", 'alt' => "")); ?>
								...
								<td class="wc_actions">
                                    <button class="e_btn1" onclick="window.location.href='<?= Router::url(array('controller' => "admin", 'action' => "webchatEdit", $vals['WxWebchat']['Id'])) ?>'">
                                    ...
                                    <button  class="e_btn1 mtm" onclick="window.location.href='<?= Router::url('/admin/wc/'.md5($vals['WxWebchat']['Id']).'/center'); ?>'">
