...
class AdminController extends AppController {
	...
	function wc($id) {
		/*
			用户微信入口  标记
			url: /wc/fdb0d408e1f94b809b4b53d487e08e54/sAroz
			$id: fdb0d408e1f94b809b4b53d487e08e54
			exit($id);
		*/
		$this->wxId = $id;
		...
		$this->set('data', $data);//强制设计data值 = $data 标记

		
		$data_wx_list['datalist'] = $this->Paginator->paginate('WxWebchat', array('FPerson' => $this->uid));
		$this->set('data_wx_list',$data_wx_list);//微信列表输出
