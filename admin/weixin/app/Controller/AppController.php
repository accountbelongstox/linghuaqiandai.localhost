...
class AppController extends Controller {
	...
	public $site_cx = "Powered by HH_Cloud";
	public $version = "1.1";
	...
	public function beforeFilter() {
		...
		$this->Auth->authError = "用户未被授权，禁止访问(login)。";
	...
	{
		$sets = array('Site' => array("title" => array('default' => "开源免费的微信公众平台开发框架"), "name" => array('default' => "HH_Cloud"), "keywords" => array(), "description" => array()));
		$conf = array();
