...
#<?php echo $module['module_name'];?>_html .parent_0 .icon img{width:80%; margin-top:5px; border:0px; background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; border-radius:0.5rem;}
