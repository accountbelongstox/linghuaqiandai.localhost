...
.process .current{ border-bottom:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?> solid 3px;}
...
#<?php echo $module['module_name'];?>_html .parent_0 a:hover{  background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['text']?>; }
#<?php echo $module['module_name'];?>_html .parent_0 .a_hover{ background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['text']?>;}
...
#<?php echo $module['module_name'];?>_html .parent_0 .a_hover:after{font: normal normal normal 1.5rem/1 FontAwesome; content:"\f0d9"; float:right; margin-top:0.5rem; margin-right:-1px;}
...
#<?php echo $module['module_name'];?>_html .parent_0 .icon img{ height:30px; width:30px; margin-top:5px; border:0px; background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; border-radius:0.5rem;}
...
#<?php echo $module['module_name'];?>_html .sub_2{ display:none; position:absolute; z-index:999;  min-height:127px;  max-width:800px; box-shadow:1px 0px 3px 0px rgba(0,0,0,.2); padding-right:20px; border:1px solid #e7e7e7; border-left:none; white-space:nowrap; background-color: #f9f9f9;}
#<?php echo $module['module_name'];?>_html .sub_2 a:hover{color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>;}
