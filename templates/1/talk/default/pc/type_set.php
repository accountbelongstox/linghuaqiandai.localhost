<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    $(document).ready(function(){
		...
		$("#<?php echo $module['module_name'];?> #sum").val('<?php echo $module['sum'];?>');
		...
		$("#<?php echo $module['module_name'];?> #submit").click(function(){
			...
			args+='|'+'sum:'+$("#<?php echo $module['module_name'];?> #sum").val();
...
<div id="<?php echo $module['module_name'];?>_html">
   	  ...
   	  <div><span class="m_label"><?php echo self::$language['show'];?></span><span class=input_span>
      		<select id="sum" name="sum"><option value="0">图片/名称</option><option value="1">图片/名称/统计</option></select> <span></span>
      		</span>
      </span></div> 
