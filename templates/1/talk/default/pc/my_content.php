<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_table .content{ margin-left:50px; width:850px; overflow:hidden; text-align:left;  font-size:15px; line-height:25px; margin-bottom:20px;}
