<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_html .msg_div .content_div .v{ display:inline-block; margin-top:-0.6rem; text-align:left; margin-bottom:20px; max-width:60%; padding:0.5rem; border-radius:0.5rem; background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['text']?>;}
	#<?php echo $module['module_name'];?>_html .msg_div .content_div:before{font: normal normal normal 18px/1 FontAwesome;margin-right: 5px;content: "\f0d8"; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; padding-left:1rem; display:block; }
	
	#<?php echo $module['module_name'];?>_html .msg_div .answer_div { text-align:right;}
	#<?php echo $module['module_name'];?>_html .msg_div .answer_div:after{font: normal normal normal 18px/1 FontAwesome;margin-right: 5px;content:"\f0d7"; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; padding-right:1rem; display:block; }
    #<?php echo $module['module_name'];?>_html .msg_div .answer_div .answer{display:inline-block; margin-bottom:-0.4rem; text-align:left;max-width:60%; padding:0.5rem; border-radius:0.5rem; background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['text']?>;}
    ...
    #<?php echo $module['module_name'];?>_html #feedback_state .current{background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['text']?>; }
    ...
    <div class="filter"><?php echo self::$language['state']?>:
        <div id=feedback_state>
       		<a href=/index.php?cloud=feedback.admin ><?php echo self::$language['unlimited'];?></a>
       		<a href=/index.php?cloud=feedback.admin&state=0 id=0><?php echo self::$language['feedback_state'][0];?></a>
       		<a href=/index.php?cloud=feedback.admin&state=1 id=1><?php echo self::$language['feedback_state'][1];?></a>
       		<a href=/index.php?cloud=feedback.admin&state=2 id=2><?php echo self::$language['feedback_state'][2];?></a>
       		<a href=/index.php?cloud=feedback.admin&state=3 id=3><?php echo self::$language['feedback_state'][3];?></a>
        </div>
    </div>
