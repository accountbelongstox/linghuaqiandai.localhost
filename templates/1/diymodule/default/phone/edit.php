<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    function exe_check(){
        ...
        if(title.prop('value')==''){cloud_alert('<?php echo self::$language['please_input']?><?php echo self::$language['name']?>');title.focus();return false;}
        if(width.prop('value')==''){cloud_alert('<?php echo self::$language['please_input']?><?php echo self::$language['module_width']?>');width.focus();return false;}
        if(height.prop('value')==''){cloud_alert('<?php echo self::$language['please_input']?><?php echo self::$language['module_height']?>');height.focus();return false;}
        if(content.prop('value')==''){cloud_alert('<?php echo self::$language['please_input']?><?php echo self::$language['content']?>');return false;}
    ...
    #<?php echo $module['module_name'];?>_html #title_visible{ height:30px;}
    #<?php echo $module['module_name'];?> #title{ width:150px;}
    #<?php echo $module['module_name'];?> #width{ width:100px; margin-top:10px;}
    #<?php echo $module['module_name'];?> #height{ width:100px; margin-top:10px;}
    ...
    <br />  &nbsp;&nbsp;&nbsp;&nbsp;<?php echo self::$language['module_width'];?>：<input type="text" name="width" id="width" value="<?php echo $module['width']?>" /> 
