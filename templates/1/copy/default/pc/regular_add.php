<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    function show_result(){
		...
		if(json.state=='success'){
			$("#<?php echo $module['module_name'];?>_html").html('<div id=r_div>'+json.info+' <a href="/index.php?cloud=travel.line_detail&id=<?php echo @$_GET['id'];?>" class=return_button><?php echo self::$language['return'];?></a></div>');
		}
    }
    </script>
...
<style>
    ...
    #<?php echo $module['module_name'];?> .line_div .m_label{ display:inline-block; width:18%; text-align:right; padding-right:5px; vertical-align:top;}
    #<?php echo $module['module_name'];?> .line_div .input_span{ display:inline-block;width:80%;}
    #<?php echo $module['module_name'];?> .line_div .input_span input{width:90%;}
