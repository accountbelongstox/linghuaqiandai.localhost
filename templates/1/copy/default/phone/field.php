<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
	...
	<style>
    #<?php echo $module['module_name'];?>_table .field_info{ display:inline-block; text-align:left; width:78%;}
	#<?php echo $module['module_name'];?>_table textarea{ min-height:45px; font-size:30px; width:70%;}
	#<?php echo $module['module_name'];?>_table #data_source_type_2{ width:50%; margin-left:20%;}
	#<?php echo $module['module_name'];?> .default_value{ width:150px;}
	...
	#<?php echo $module['module_name'];?> .data_type_option_div{ display:none; background-image:url(<?php echo get_template_dir(__FILE__);?>img/data_type_option_div_bg.png); border:1px solid #b2e7ff; padding-left:20%;}
	#<?php echo $module['module_name'];?> .data_type_option_div select{}
	#<?php echo $module['module_name'];?> .data_type_option_div input{ min-width:40%;}
