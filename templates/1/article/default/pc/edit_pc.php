...
<div id="<?php echo $module['module_name'];?>_html">
    <ul class="nav nav-tabs">
      <li role="presentation" class="active"><a href="/index.php?cloud=article.edit&id=<?php echo $_GET['id']?>&type=pc"><?php echo self::$language['pc_device'];?></a></li>
      <li role="presentation"><a href="/index.php?cloud=article.edit&id=<?php echo $_GET['id']?>&type=phone"><?php echo self::$language['phone_device'];?></a></li>
	</ul>
    <form id="cloud_form" name="cloud_form" method="POST" action="<?php echo $module['action_url'];?>&id=<?php echo $_GET['id'];?>" onSubmit="return exe_check();">
      ...
      <?php echo $module['parent'];?></select> <a href="index.php?cloud=article.type"><?php echo self::$language['create']?></a><br /><br />
    ...
    <div id=advanced_options_div>
		<span class="m_label"><?php echo self::$language['tag'];?>：</span><input type="text" name="tag" id="tag"   placeholder="<?php echo self::$language['diy_tag'];?>"  value="<?php echo $module['tag'];?>"/><br /><br />
