<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
	...
	<style>
    #<?php echo $module['module_name'];?>_table .type{}
    #<?php echo $module['module_name'];?>_table .title{ width:10rem;}
    ...
    #<?php echo $module['module_name'];?> .thumb_article{ margin-left:20%;}
    #<?php echo $module['module_name'];?>_table .thumb_article{ width:3rem; border:0px;}
    </style>
    <div id="<?php echo $module['module_name'];?>_html"  cloud-table=1>
    <div class="filter">
        <?php echo $module['filter']?>
        <input type="text" name="search_filter" id="search_filter" placeholder="<?php echo self::$language['title']?>/<?php echo self::$language['content']?>/<?php echo self::$language['tag'];?>" value="<?php echo @$_GET['search']?>" />
