...
<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#index_user_position a[href='index.php?cloud=form.table_edit']").attr('href','index.php?cloud=form.table_edit&id=<?php echo $module['data']['table_id'];?>');
		...
		$("#<?php echo $module['module_name'];?> #submit").click(function(){
			...
			$.post('<?php echo $module['action_url'];?>&act=update',{ description:j_description.val(), name: j_name.val(),placeholder:$("#placeholder").val(),required:$("#required").val(),unique:$("#unique").val(),search_able:$("#search_able").val(),reg:$("#reg").val(),input_type:$("#input_type").val(),args:args} ,function(data){
				//alert(data);	
                ...
                if(v.state=='success'){
                	...
                	window.location.href='/index.php?cloud=form.table_edit&id='+v.table_id;
                }
...
<div id="<?php echo $module['module_name'];?>_html" class="<?php echo $module['module_name'];?>_html">
    	<div><span class=m_label><span class=required_item>*</span><?php echo self::$language['field'];?><?php echo self::$language['name'];?></span><span class=input_span><input type="text" id="description" value="<?php echo $module['data']['description'];?>" /><span></span></span></div>
    	<div><span class=m_label><span class=required_item>*</span><?php echo self::$language['field_name'];?></span><span class=input_span><input type="text" id="name" placeholder="<?php echo self::$language['only_letters_numbers_underscores'];?>"  value="<?php echo $module['data']['name'];?>"  /><span></span></span></div>       
        ...
        </select><span></span> <?php echo self::$language['change_sql_type_warning'];?></span>
        <div id=args_div>
