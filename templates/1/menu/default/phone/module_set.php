<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    <div id="<?php echo $module['module_name'];?>_html">
   	  <div><span class="m_label"><?php echo self::$language['data_src'];?></span><span class=input_span>
      		<select id="id" name="id" cloud_value="<?php echo $module['id']?>"><?php echo $module['data_src_option'];?></select> <span></span> 
      </span></div> 

      
   	  <div><span class="m_label"><?php echo self::$language['template'];?></span><span class=input_span>
      		<select id="template" name="template" cloud_value="<?php echo $module['template']?>"><?php echo $module['template_option'];?></select><span></span>
      		</span>
      </span></div> 
