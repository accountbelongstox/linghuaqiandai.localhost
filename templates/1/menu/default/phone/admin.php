<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		$("#<?php echo $module['module_name'];?> .name").css('width','200px');
		...
		$('.icon').click(function(){
			...
			$("#cloud_iframe").attr('src','index.php?cloud=index.replace_file&path='+replace_file+'&width=512&height=512');
			return false;	
		});
...
$.get('<?php echo $module['action_url'];?>&act=del',{id:id}, function(data){
    ...
    #<?php echo $module['module_name'];?> .name{ display:inline-block; vertical-align:top;}
    #<?php echo $module['module_name'];?> .url{}
	...
	#<?php echo $module['module_name'];?> .icon{background:#ff9600; border-radius:3px; display:inline-block; vertical-align:top; width:60px; height:60px; padding:2px; margin-right:5px;}
	#<?php echo $module['module_name'];?> .icon img{ width:60px; height:60px; border:0px;}
    </style>
    ...
    <div class="filter">
        ...
        <br /><input type="text" name="search_filter" id="search_filter" placeholder="<?php echo self::$language['name']?>/<?php echo self::$language['url']?>" value="<?php echo @$_GET['search']?>" />
    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"   id="<?php echo $module['module_name'];?>_table_a" style="width:100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <td width="18%"><?php echo self::$language['name']?></td>
                <td width="22%"><?php echo self::$language['url']?></td>
        ...
        <tbody >
            <tr id="new">
                ...
                <td width="168"><input type="text" name="name_new" id="name_new" class='name' /></td>
    ...
    <div class=batch_operation_div>
                ...
                <a href="#" class="reverse_select" onclick="return reverse_select();"><?php echo self::$language['reverse_select']?></a>
                 <br /><span class="selected"><?php echo self::$language['selected']?>:</span>
                 ...
                 <a href="#" class="show"  onclick="return show_select(1);"><?php echo self::$language['show']?></a> 
                 <a href="#" class="hide" onclick="return show_select(0);"><?php echo self::$language['hide']?></a>
