...
<?php require("./include/return_data/css/increase_user.php");?>
<div id="<?php echo $module['module_name'];?>_html" class="<?php echo $module['module_name'];?>_html">
    	...
    	<div class=line><span class=m_label>微信号</span><span class=input> <input type="text" class=chip  /> <span class=state></span></span></div>
