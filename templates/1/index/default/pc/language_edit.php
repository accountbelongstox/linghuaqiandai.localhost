<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_html .m_label{width:600px;; display:inline-block;  text-align:right;white-space: normal;}
    #<?php echo $module['module_name'];?>_html .content{ display:inline-block; padding-left:10px;}
