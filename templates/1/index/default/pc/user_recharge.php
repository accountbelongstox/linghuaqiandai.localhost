...
<div id="<?php echo $module['module_name'];?>_html">
    	...
    	<div class=line><span class=m_label><?php echo self::$language['recharge']?><?php echo self::$language['amount']?></span><span class=input> <input type="text" class=money value=""  /> <span class=state></span></span></div>        
    	<div class=line><span class=m_label><?php echo self::$language['recharge']?><?php echo self::$language['reason']?></span><span class=input> <input type="text" class=reason value=""  /> <span class=state></span></span></div>        
