...
<div id="<?php echo $module['module_name'];?>_html" class="<?php echo $module['module_name'];?>_html">
  ...
  <li role="presentation"><a href="/index.php?cloud=index.right_buttons&type=pc"><?php echo self::$language['pc_device'];?></a></li>
  <li role="presentation" class="active"><a href="/index.php?cloud=index.right_buttons&type=phone"><?php echo self::$language['phone_device'];?></a></li>
</ul>
