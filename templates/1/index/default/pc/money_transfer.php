        ...
        $("#submit").click(function(){
            ...
            $("#submit_state").load('<?php echo $module['action_url'];?>&act=submit',json,function(){
                if($(this).html().length>10){
					...
					if(v.state=='success'){
						$(this).html(v.info+" <a href='/index.php?cloud=index.money_transfer_log'><?php echo self::$language['view']?></a>");
					}else{
...
<style>
    #<?php echo $module['module_name'];?>_html{ padding-top:10px; border:1px solid #CCC;}
...
<div id="<?php echo $module['module_name'];?>_html">
    ...
    <tr ><td width="10%" align="right"><span><?php echo self::$language['user_money'];?></span></td>
