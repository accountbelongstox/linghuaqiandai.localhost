<?php
    require("./include/return_data/css/admin_edit_user.php");
?>
<div id="<?php echo $module['module_name'];?>"  class="portlet <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left >
<script src="/plugin/datePicker/index.php"></script>
    ...
    $(document).ready(function(){
        ...
        $('#weixincode_ele').insertBefore($('#weixincode_state'));
...
<div id="<?php echo $module['module_name'];?>_html" class="<?php echo $module['module_name'];?>_html">
    ...
    <div id="select_div">
        <div class="c_option active">编辑用户</div>
    </div>
    ...
    <table border="0" cellpadding="0" cellspacing="0" id="<?php echo $module['module_name'];?>_table"  class="portlet light <?php echo $module['module_name'];?>_table" cloud-module="<?php echo $module['module_name'];?>" align=left _table >
    ...
    <img id="icon_img" class="up_img" src="/upload/index/user_icon/<?php echo $module['icon']?>" width="150"><br />
    ...
    <img id="license_photo_front_img" class="up_img" src="/upload/index/user_license_photo_front/<?php echo $module['license_photo_front']?>" width="150"><br />
    ...
    <img id="license_photo_reverse_img" class="up_img" src="/upload/index/user_license_photo_reverse/<?php echo $module['license_photo_reverse']?>" width="150"><br />
    ...
    <img id="weixincode_img" class="up_img" src="/upload/index/user_weixincode/<?php echo $module['weixincode']?>" width="150"><br />
    <span id="weixincode_state"></span></td></tr>
