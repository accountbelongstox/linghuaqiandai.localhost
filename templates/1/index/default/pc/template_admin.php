<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left >
	...
	.info_div a{ }
    #<?php echo $module['module_name'];?>_html #icons li{line-height:20px;  list-style-type:none; display:inline-block; vertical-align:middle; width:30%; margin-bottom:2rem;  }
    ...
    #<?php echo $module['module_name'];?>_html .icon_div img{width:70px; height:70px; border:0px; background:none;}
    #<?php echo $module['module_name'];?>_html .icon_div:hover img{width:70px; height:70px; opacity:0.9;}
	...
	#<?php echo $module['module_name'];?>_html li{  list-style:none !important;}
