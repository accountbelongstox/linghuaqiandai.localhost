...
<div id="<?php echo $module['module_name'];?>_html">
    ...
    <div><span class="m_label"><?php echo self::$language['step_1'];?></span><span class=input><?php echo self::$language['download_the_upgrade_patch_from_cloud_server'];?> <a href="<?php echo $module['download_url'];?>" target="_blank"><?php echo self::$language['click'];?><?php echo self::$language['download'];?></a></span></div>
    <hr />
