<div id=<?php echo $module['module_name'];?>  class="portlet light sum_card" cloud-module="<?php echo $module['module_name'];?>" align=left >
	...
	#<?php echo $module['module_name'];?> .big_num{background-color: #390; }
...
<div id="<?php echo $module['module_name'];?>_html">
    	<a href='/index.php?cloud=index.admin_users' class=card_head>
        	<span class=big_num><?php echo $module['user'];?></span>
            <span class=remark><?php echo self::$language['member'];?></span>
        </a>
    	<div class=card_body>
        	<a href='/index.php?cloud=index.admin_users' class=item>
            ...
            </div><a href='/index.php?cloud=index.admin_site_msg' class=item>
            ...
            </a><a href='/index.php?cloud=index.credits_admin' class=item>
            ...
            </a><a href='/index.php?cloud=index.recharge_log_admin&state=4' class=item>
            ...
            </a><a href='/index.php?cloud=index.withdraw_log_admin&state=1' class=item>
