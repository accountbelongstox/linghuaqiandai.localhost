<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
        ...
        $("#<?php echo $module['module_name'];?>_html .checkbox").click(function(){
            if($(this).prop('checked')){visible=1;}else{visible=0;}
            data="{'url':'"+$(this).attr("id")+"','visible':'"+visible+"'}";
            try{json=eval("("+data+")");}catch(exception){alert(data);}
            $("#<?php echo $module['module_name'];?>_html #visible_state").load("<?php echo $module['action_url'];?>",json,function(){
                ...
                if($(this).html().length>5){
                    ...
                    $(this).html(v.info);
                    if(v.state=='fail'){cloud_alert(v.info);}
                }	
            });
	...
	#<?php echo $module['module_name'];?>_html fieldset{ display:block; margin:40px; color:#FFF;}
	#<?php echo $module['module_name'];?>_html fieldset li{ list-style:none; display:inline-block; vertical-align:top; width:33%; text-align:center; margin-bottom:3rem;}
	...
	#<?php echo $module['module_name'];?>_html fieldset li div .checkbox{ position:static; display:inline-block; height:1rem; line-height:1rem;}
/*表单DIYMODULE设计CSS 载入 2*/
<?php require("./include/return_data/css/form_data_admin.php");?>
</style>
<div id="<?php echo $module['module_name'];?>_html">
     <div id="visible_state" style="display:none;"></div>
    <table cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td id="left_groups" width="32%" align="right">
    <?php echo $module['groups']?>
        ...
        <tbody>
          <tr>
            ...
            <td id="menu_td">
                <table border="0" cellspacing="1" cellpadding="0" id="index_edit_menu_table"> 
                  <tr>
                    <td rowspan="2" class="step"><a href="index.php?cloud=index.<?php echo $module['act'];?>_menu&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['menu']?></a></td>
                    <td class=step_view  id="index_view_menu_td"><a href="index.php?cloud=index.view_menu&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['view']?></a></td>
                  </tr>
                  <tr>
                    <td  class="step_edit" id="index_edit_menu_td"><a href="index.php?cloud=index.edit_menu&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['edit']?></a></td>
                  </tr>
                </table> 
            
            </td>
            <td id="page_td">
                <table border="0" cellspacing="2" cellpadding="0" id="index_edit_page_table">
                  <tr>
                    <td rowspan="2" class="step"><a href="index.php?cloud=index.<?php echo $module['act'];?>_page&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['page_power']?></a></td>
                    <td class=step_view  id="index_view_page_td"><a href="index.php?cloud=index.view_page&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['view']?></a></td>
                  </tr>
                  <tr>
                    <td  class="step_edit" id="index_edit_page_td"><a href="index.php?cloud=index.edit_page&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['edit']?></a></td>
                  </tr>
                </table>         
            </td>
            <td id="function_td">
                <table border="0" cellspacing="2" cellpadding="0" id="index_edit_function_table" >
                  <tr>
                    <td rowspan="2" class="step"><a href="index.php?cloud=index.<?php echo $module['act'];?>_function&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['function_power']?></a></td>
                    <td class=step_view  id="index_view_function_td"><a href="index.php?cloud=index.view_function&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['view']?></a></td>
                  </tr>
                  <tr>
                    <td  class="step_edit" id="index_edit_function_td"><a href="index.php?cloud=index.edit_function&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['edit']?></a></td>
                  </tr>
                </table>         
            </td>
          </tr>
