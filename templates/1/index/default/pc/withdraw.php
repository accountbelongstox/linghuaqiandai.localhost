...
<style>
	...
	#<?php echo $module['module_name'];?> .line .m_label{ display:inline-block; vertical-align: middle; width:10%; text-align:right; padding-right:10px; box-shadow:none; }
...
<div id="<?php echo $module['module_name'];?>_html">
    <div id=pay_method>
    	...
    	<div class="line method_0"><span class=m_label><?php echo self::$language['billing_info']?></span><span class=value><input type="text" id='billing_info' name='billing_info' value="<?php echo self::$language['billing_info_template'];?>" style="width:800px;" /></span></div>
