<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    $(document).ready(function(){
		...
		$('.icon').click(function(){
			...
			$("#cloud_iframe").attr('src','index.php?cloud=index.replace_file&path='+replace_file+'&width=128&height=128');
			return false;	
		});
    ...
    <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"   id="<?php echo $module['module_name'];?>_table_a" style="width:100%" cellspacing="0">
        ...
        <tbody >
            <tr id="new">
              ...
              <td><input type="text" name="center_new" id="center_new" class='center' cloud_type="map" /></td>
              <td><input type="text" name="range_new" id="range_new" class='range' /></td>
              <td><div class=area_div><input type="hidden" name="area" id="area" class='area' />  <script src="include/core/area_js.php?callback=set_area&input_id=area&id=0&level=4&output=select" id='area_area_js'></script> <span class=state id=area_state></span></div></td>
