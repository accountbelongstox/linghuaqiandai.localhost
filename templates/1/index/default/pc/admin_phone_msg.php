<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_table .content{width:340px;display:inline-block; margin-right:10px; overflow:hidden;}
    ...
    #<?php echo $module['module_name'];?>_table .sender{width:150px;height:40px; display:inline-block; margin-right:10px; overflow:hidden;}
