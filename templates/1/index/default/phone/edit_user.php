<div id=<?php echo $module['module_name'];?>  class="" cloud-module="<?php echo $module['module_name'];?>" align=left >
<script src="./plugin/datePicker/index.php"></script>
    ...
    $(document).ready(function(){
       ...
       $("#<?php echo $module['module_name'];?>_html .up_img").each(function(i,e){
        ...
        $("#icon").change(function(){cloud_alert('hidden');});
  ...
  //      });
	...
	<style>
    #<?php echo $module['module_name'];?>_html{line-height:2.5rem;} 
    #<?php echo $module['module_name'];?>_html #index_edit_user{ }
    #<?php echo $module['module_name'];?>_html #username_state{}
    #<?php echo $module['module_name'];?>_html input{ width:80%; }
    #<?php echo $module['module_name'];?>_html select{ }
    #<?php echo $module['module_name'];?>_html #icon_img{;}
    #<?php echo $module['module_name'];?>_html .input_text{}
    #<?php echo $module['module_name'];?>_html #license_photo_front_img{ }
    #<?php echo $module['module_name'];?>_html #license_photo_reverse_img{ }
	#<?php echo $module['module_name'];?>_html #old_password{}
	#<?php echo $module['module_name'];?>_html #new_password{}
	#<?php echo $module['module_name'];?>_html #confirm_new_password{}
	#<?php echo $module['module_name'];?>_html #old_transaction_password{}
	#<?php echo $module['module_name'];?>_html #new_transaction_password{}
	#<?php echo $module['module_name'];?>_html #confirm_new_transaction_password{}
	#<?php echo $module['module_name'];?>_html #old_transaction_password_state{ }
	#<?php echo $module['module_name'];?>_html #find_transaction_password{  }
    #<?php echo $module['module_name'];?>_html .m_label{width:8rem;; text-align:right; padding-right:0.3rem;}
	...
	#update_password{  margin-top:2rem; margin-bottom:5rem;}
	#update_password .m_label{width:11rem;;}
	#update_transaction_password{  margin-top:2rem; margin-bottom:5rem;}
	#update_transaction_password .m_label{width:11rem;;}
    ...
    <table border="0" cellpadding="0" cellspacing="0" id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left _table style="width:100%;">
    ...
    <tr id="tr_real_name"><td class="m_label"><?php echo self::$language['real_name']?></td><td align="left"><input type="text" id="real_name" name="real_name" value="<?php echo $module['real_name']?>"  placeholder="<?php echo self::$language['the_future_cannot_be_modified'];?>" /><span id="real_name_state"></span></td></tr>
    ...
    <tr id="tr_transaction_password"><td colspan="2">
        <table id="update_transaction_password" style="width:100%; white-space:nowrap;">
