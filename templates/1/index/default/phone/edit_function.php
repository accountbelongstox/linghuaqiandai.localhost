          ...
          <tr>
            ...
            <td id="function_td">
                <table border="0" cellspacing="2" cellpadding="0" id="index_edit_function_table" >
                  <tr>
                    <td rowspan="2" class="step"><a href="index.php?pageindex.<?php echo $module['act'];?>_function&id=<?php echo $_GET['id'];?>&program=<?php echo @$_GET['program'];?>"><?php echo self::$language['function_power']?></a></td>
