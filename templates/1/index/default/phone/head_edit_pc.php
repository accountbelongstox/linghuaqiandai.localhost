<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <ul class="nav nav-tabs">
      <li role="presentation" class="active"><a href="/index.php?cloud=index.head_edit&type=pc"><?php echo self::$language['pc_device'];?></a></li>
      <li role="presentation"><a href="/index.php?cloud=index.head_edit&type=phone"><?php echo self::$language['phone_device'];?></a></li>
	</ul>
    
    <form id="cloud_form" name="cloud_form" method="POST" action="<?php echo $module['action_url'];?>" onSubmit="return exe_check();">
    <textarea name="content" id="content" style="display:none; width:100%; height:400px;"><?php echo $module['data']?></textarea>
