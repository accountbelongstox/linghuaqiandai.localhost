<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_table .title{display:block; width:12rem;}
    #<?php echo $module['module_name'];?>_table .time{ }
    #<?php echo $module['module_name'];?>_table .sender{ display:block; width:12rem;}
    ...
    <div class="filter">
     <?php echo $module['filter']?>
        <input type="text" name="search_filter" id="search_filter" placeholder="<?php echo self::$language['title']?>/<?php echo self::$language['content']?>/<?php echo self::$language['username']?>" value="<?php echo @$_GET['search']?>" />
