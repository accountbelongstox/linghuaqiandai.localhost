...
<script src="./plugin/datePicker/index.php"></script>
	...
	#<?php echo $module['module_name'];?> table tr{background:none !important; }
	#<?php echo $module['module_name'];?> table tr input{background:none !important; }
    </style>
    ...
    <div class=table_scroll><table border="0" cellpadding="0" cellspacing="0" id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left _table style="width:100%;">
    ...
    <tr id="tr_password"><td colspan="2">
        <div class=table_scroll><table id="update_password">
    ...
    <tr id="tr_transaction_password"><td colspan="2">
        <div class=table_scroll><table id="update_transaction_password">
