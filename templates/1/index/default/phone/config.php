<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_html .input_text{width:60%;}
    #<?php echo $module['module_name'];?>_html div{ line-height:2.5rem; white-space:nowrap;}
    #<?php echo $module['module_name'];?>_html .m_label{width:49%; display:inline-block;  text-align:right;}
    #<?php echo $module['module_name'];?>_html .content{width:50%; display:inline-block; margin-left:15px; }
    #<?php echo $module['module_name'];?>_html .content input{width:60%;}
    #<?php echo $module['module_name'];?>_html #web__description{width:80%;margin-top:15px; border-radius:3px; border:1px solid #CCC; line-height: 24px; min-height:120px;}
    #<?php echo $module['module_name'];?>_html #web__diy_meta{width:80%; margin-top:15px; border-radius:3px; border:1px solid #CCC;line-height: 24px;}
	#<?php echo $module['module_name'];?>_html #sms__disable_phrase{width:80%;margin-top:15px; border-radius:3px; border:1px solid #CCC;}
