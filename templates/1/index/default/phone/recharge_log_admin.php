...
<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_html .pay_photo{ background-image:url(<?php echo get_template_dir(__FILE__);?>img/pay_photo_icon.png); background-repeat:no-repeat; display:inline-block; height:30px; width:30px;}
    #<?php echo $module['module_name'];?>_html .pay_photo:hover{ text-decoration:none;} 
    #<?php echo $module['module_name'];?>_html .pay_info{ background-image:url(<?php echo get_template_dir(__FILE__);?>img/pay_info_icon.png); background-repeat:no-repeat; display:inline-block; height:30px; width:30px;}
    #<?php echo $module['module_name'];?>_html .pay_info:hover{ text-decoration:none;}
    ...
    #<?php echo $module['module_name'];?>_table .operation{width:250px;display:inline-block; text-align:left;}
