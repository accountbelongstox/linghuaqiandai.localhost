<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    <style>
        ...
        #<?php echo $module['module_name'];?>_html #left_groups{width:7rem;vertical-align:text-top;}
        #<?php echo $module['module_name'];?>_html #left_groups a{ display:block; text-align:left; background-color:#F60; padding:5px; margin:5px; padding-right:0px;  color:#FFF; font-size:1rem; line-height:30px; margin-right:-5px; padding-left:10px; background-position:right; background-repeat:repeat-y;}
	    #<?php echo $module['module_name'];?>_html #left_groups a:hover{ opacity:0.8;}
        #<?php echo $module['module_name'];?>_html #left_groups .current{ display:block; text-align:left; background: #EFEFEF; margin:5px; margin-right:-5px;  color:#383838; line-height:35px; padding-left:10px;}
		...
		[m_name]{ cursor:move; display:inline-block; width:150px; background-color: #690; color:#FFF; line-height:30px; padding:10px; margin:10px;}
		#right_td .available{ display:inline-block; vertical-align:top; width:50%;min-height:500px; height:100%;overflow:hidden;float: right;margin-right: 5%;}
    ...
    <div id="<?php echo $module['module_name'];?>_html">
        ...
        <?php echo $module['groups']?>
        	...
        	<div class=existing  data="<?php echo $module['user_sum'];?> "></div>
