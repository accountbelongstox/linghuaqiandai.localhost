...
$(document).ready(function(){
	...
	$("#<?php echo $module['module_name'];?> .submit").click(function(){
		...
		$.post('<?php echo $module['action_url'];?>&act=update',{authcode:$("#<?php echo $module['module_name'];?> .authcode").val()}, function(data){
			...
			if(v.state=='success'){
				$("#<?php echo $module['module_name'];?>").html('<div style="line-height:200px;text-align:center;">'+v.info+' <a href=/index.php?cloud=index.openid><?php echo self::$language['refresh']?></a></div>');
			}
		});
       ...
       <div class="modal-dialog">
          <div class="modal-content">
             ...
             <div class="modal-body" style="text-align:center;">
                 <img class="qr_img" src=/images/weixin_scan_img_demo.gif width="80%" />
             </div>
