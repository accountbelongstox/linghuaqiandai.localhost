...
<div id="<?php echo $module['module_name'];?>_html" class="<?php echo $module['module_name'];?>_html" cloud-table="1" class="<?php echo $module['module_name'];?>_html">
    ...
    <div style="text-align:right;"><a href=/index.php?cloud=axis.content&axis_id=<?php echo $_GET['axis_id']?>&id=0 class="add set_content"><?php echo self::$language['add']?><?php echo self::$language['pages']['axis.log']['name']?></a><div>
