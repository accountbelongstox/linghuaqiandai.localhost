<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    function update(id){
        ...
        $.get('<?php echo $module['action_url'];?>&act=update',{name:name.prop('value'),style:style.prop('value'),sequence:sequence.prop('value'),state:state,id:id}, function(data){
			//alert(data);
   ...
   <div class=table_scroll><table class="table table-striped table-bordered table-hover dataTable no-footer"  role="grid"  id="<?php echo $module['module_name'];?>_table" style="width:100%" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <td ><?php echo self::$language['axis_sequence']?></td>
        ...
        <tbody>
            <tr>
                <td width="4%">&nbsp;</td>
                <td ><input id="name_new" name="name_new" class="name" /></td>
                <td ><select class="style" id=style_new name=style_new><?php echo $module['style_option'];?></select></td>
                <td class="operation_td" colspan=5><a href="#" onclick="return add()"  class='add'><?php echo self::$language['add']?></a> <span id=state_new  class='state'></span></td>
            </tr>
