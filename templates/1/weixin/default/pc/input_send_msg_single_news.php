...
<!-----------------------------------------------------------------------------------answer_content_input_start-->
                    ...
                    $(document).ready(function(){
                        ...
                        $("#<?php echo $module['module_name'];?> #submit").click(function(){
							...
							$.post('<?php echo $module['action_url'];?>',{img:$("#<?php echo $module['module_name'];?> #img").val(),title:$("#<?php echo $module['module_name'];?> #title").val(),description:$("#<?php echo $module['module_name'];?> #description").val(),url:$("#<?php echo $module['module_name'];?> #url").val()}, function(data){
								//alert(data);
