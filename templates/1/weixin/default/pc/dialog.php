<div id=<?php echo $module['module_name'];?>  class="portlet light <?php echo $module['module_name'];?>" cloud-module="<?php echo $module['module_name'];?>" align=left save_name="<?php echo $module['module_save_name'];?>"  >
    <script src="/plugin/datePicker/index.php"></script>
	
    
    <script>
    $(document).ready(function(){
		$("#<?php echo $module['module_name'];?>").css('width',$(".container").width());
    ...
    #<?php echo $module['module_name'];?>_html .left_div .web_c .c{ display:inline-block; margin-bottom:-0.6rem; text-align:left; margin-top:20px; max-width:60%; padding:0.5rem; border-radius:0.5rem; background:<?php echo $_POST['cloud_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_2_hover']['text']?>;}
	#<?php echo $module['module_name'];?>_html .left_div .web_c:after{font: normal normal normal 18px/1 FontAwesome;margin-right: 5px;content:"\f0d7"; color:<?php echo $_POST['cloud_user_color_set']['nv_2_hover']['background']?>; padding-left:1rem; display:block; }
	...
	#<?php echo $module['module_name'];?>_html .right_div  .web_c:after{font: normal normal normal 18px/1 FontAwesome;margin-right: 5px;content:"\f0d7"; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; padding-right:1rem; display:block; }
