...
<!-----------------------------------------------------------------------------------answer_content_input_start-->
					<script>
                    $(document).ready(function(){
						$('#image_ele').insertBefore($('#image_state'));
                        ...
                        $("#<?php echo $module['module_name'];?> #submit").click(function(){
							...
							$.post('<?php echo $module['action_url'];?>',{key:$("#<?php echo $module['module_name'];?> #key").val(),image:$("#<?php echo $module['module_name'];?> #image").val()}, function(data){
								//alert(data);
...
?>
                	...
                	<br />
                    <?php echo $module['data']['image'];?>
                    <a href=# class="replace"><?php echo self::$language['replace'];?></a>  <div id=replace_div><span id=image_state></span></div>
