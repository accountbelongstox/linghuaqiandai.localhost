...
<div id="<?php echo $module['module_name'];?>_html" class="<?php echo $module['module_name'];?>_html" cloud-table="1">
    ...
    <div class="filter" style="text-align:left;"><a href="#" onclick="return get_user_list();" class="add"><span class=b_start> </span><span class=b_middle><?php echo self::$language['get_user_list']?></span><span class=b_end> </span></a> <span id="get_user_list_state"></span>
    </div>
