...
<!-----------------------------------------------------------------------------------answer_content_input_start-->
                    ...
                    $(document).ready(function(){
                        $("#<?php echo $module['module_name'];?> #submit").click(function(){
							...
							$.post('<?php echo $module['action_url'];?>',{key:$("#<?php echo $module['module_name'];?> #key").val(),text:$("#<?php echo $module['module_name'];?> #text").val()}, function(data){
								//alert(data);
                    ...
                    #<?php echo $module['module_name'];?>_html #text{width:100%; height:200px;}
                    </style>
...
?>
               		...
               		<textarea name="text" id="text"><?php echo $module['data']['text'];?></textarea> <span id=text_state></span>
