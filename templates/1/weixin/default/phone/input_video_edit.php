...
<!-----------------------------------------------------------------------------------answer_content_input_start-->
					<script>
                    $(document).ready(function(){
						$('#video_ele').insertBefore($('#video_state'));
                        ...
                        $("#<?php echo $module['module_name'];?> #submit").click(function(){
							...
							$("#<?php echo $module['module_name'];?> #image_state").html('');
							$("#<?php echo $module['module_name'];?> #submit_state").html('<span class=\'fa fa-spinner fa-spin\'></span>');
							
							$.post('<?php echo $module['action_url'];?>',{key:$("#<?php echo $module['module_name'];?> #key").val(),video:$("#<?php echo $module['module_name'];?> #video").val()}, function(data){
								//alert(data);
...
?>
                	...
                	<br />
                    <?php echo $module['data']['video'];?>
                    <a href=# class="replace"><?php echo self::$language['replace'];?></a>  <div id=replace_div><span id=video_state></span></div>
