<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    $(document).ready(function(){
		...
		$("#<?php echo $module['module_name'];?> fieldset table").css('width','100%');
	...
	#<?php echo $module['module_name'];?>_html #receive_if_email{ width:30px;}
	#<?php echo $module['module_name'];?>_html #receive_if_weixin{ width:30px;}
	#<?php echo $module['module_name'];?>_html #no_keyword_if_email{ width:30px;}
	#<?php echo $module['module_name'];?>_html #no_keyword_if_weixin{ width:30px;}
	#<?php echo $module['module_name'];?>_html #no_search_if_email{ width:30px;}
	#<?php echo $module['module_name'];?>_html #no_search_if_weixin{ width:30px;}
    #<?php echo $module['module_name'];?>_html #qr_code_file{ border:none;}
 	#<?php echo $module['module_name'];?>_html .line_div{ line-height:3rem; white-space:nowrap;}
 	#<?php echo $module['module_name'];?>_html .m_label{ display:inline-block; width:38%; text-align:right; padding-right:10px; font-weight:bold;}
	#<?php echo $module['module_name'];?>_html .input{ display:inline-block;}
	#<?php echo $module['module_name'];?>_html .input input{ width:400px;}
...
?>
    ...
    <div class=line_div><span class=m_label><span class=required>*</span><?php echo self::$language['weixin'];?><?php echo self::$language['qr_code'];?></span><span class=input>
      <img src=/program/weixin/qr_code/<?php echo $module['data']['qr_code'];?> style="width:3rem;" /><br />        
    ...
    <div class=line_div><span class=m_label><?php echo self::$language['no_keyword'];?></span><span class=input><input type="checkbox" class=if_checkbox style="width:40px;" id=open_search name=open_search value="<?php echo $module['data']['open_search'];?>"><?php echo self::$language['open_search'];?></span></div>
    ...
    <div class=line_div id=inform_div  style="display:none;"><span class=m_label>&nbsp;</span><span class=input>
		...
		<div class=line_div><span class=m_label style=" width:200px;">&nbsp;</span><span class=input>
        	<fieldset><legend><?php echo self::$language['smtp_config'];?></legend>
				<div class=line_div><?php echo self::$language['smtp_url'];?><br /><input type="text" name="smtp_url" id="smtp_url" value="<?php echo $module['data']['smtp_url'];?>" /><span id=smtp_url_state class=state></span></div>
				<div class=line_div><?php echo self::$language['smtp_account'];?><br /><input type="text" name="smtp_account" id="smtp_account" value="<?php echo $module['data']['smtp_account'];?>" /><span id=smtp_account_state class=state></span></div>
				<div class=line_div><?php echo self::$language['smtp_password'];?><br /><input type="password" name="smtp_password" id="smtp_password" value="<?php echo $module['data']['smtp_password'];?>" /><span id=smtp_password_state class=state></span></div>
            </fieldset>
        </span></div>
        </fieldset>
    ...
    <div class=line_div id=receptionist_div style="display:none;"><span class=m_label>&nbsp;</span><span class=input style="display:block;">
    	<fieldset><legend>人工客服设置</legend>
   			<div class=line_div><span class=m_label style="width:50%;">启用人工服务</span><span class=input><select id=receptionist_open name=receptionist_open cloud_value="<?php echo $module['data']['receptionist_open'];?>"><option value="0"><?php echo self::$language['no'];?></option><option value="1"><?php echo self::$language['yes'];?></option></select> </span></div>
   			<div class=line_div><span class=m_label style="width:50%;">转人工客服条件,当</span><span class=input><select id=receptionist_where name=receptionist_where cloud_value="<?php echo $module['data']['receptionist_where'];?>"><option value="0">收到信息时</option><option value="1">无自动回复时</option><option value="2">无搜索结果时</option></select> </span></div>
        </fieldset>
