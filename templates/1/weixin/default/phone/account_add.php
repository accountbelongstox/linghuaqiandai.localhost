<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left  >
    ...
    #<?php echo $module['module_name'];?>_html #keyword{ width:60%;}
	#<?php echo $module['module_name'];?>_html #name{ width:60%;}
	#<?php echo $module['module_name'];?>_html #account{ width:60%;}
	#<?php echo $module['module_name'];?>_html #wid{ width:60%;}
	#<?php echo $module['module_name'];?>_html #token{ width:60%;}
	#<?php echo $module['module_name'];?>_html #AppId{ width:60%;}
	#<?php echo $module['module_name'];?>_html #AppSecret{ width:60%;}
    #<?php echo $module['module_name'];?>_html #qr_code_file{ border:none;}
 	...
 	#<?php echo $module['module_name'];?>_html .m_label{ display:inline-block; width:30%; text-align:right; padding-right:10px;}
