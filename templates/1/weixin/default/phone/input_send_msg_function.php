...
<!-----------------------------------------------------------------------------------answer_content_input_start-->
                    ...
                    $(document).ready(function(){
                        $("#<?php echo $module['module_name'];?> #submit").click(function(){
							...
							$.post('<?php echo $module['action_url'];?>',{function_v:$("#<?php echo $module['module_name'];?> #function").val()}, function(data){
								//alert(data);
...
require("./include/return_data/css/weixin_css.php");
?>
               		<select id=function name=function ><?php echo $module['function_option'];?></select>
