...
?>
    ...
    <div class="filter">
        <input type="text" name="search_filter" id="search_filter" placeholder="<?php echo self::$language['function_name']?>/<?php echo self::$language['function_description']?>" value="<?php echo @$_GET['search']?>"  style="width:60%;" />
