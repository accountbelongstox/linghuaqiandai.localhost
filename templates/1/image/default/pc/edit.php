...
<div id="<?php echo $module['module_name'];?>_html">
    ...
    <form id="cloud_form" name="cloud_form" method="POST" action="<?php echo $module['action_url'];?>&id=<?php echo $_GET['id'];?>" onSubmit="return exe_check();">
      ...
      <?php echo $module['parent'];?></select> <a href="index.php?cloud=image.type"><?php echo self::$language['create']?></a><br /><br />
      ...
      <img src='/program/image/img_thumb/<?php echo $module['src'];?>'><br />
