<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?>_table .title{ margin-top:10px;margin-bottom:10px;}
    #<?php echo $module['module_name'];?>_table .editor{}
    ...
    #<?php echo $module['module_name'];?>_table .thumb_img{ width:3rem; border:0px; margin-left:20%; border:1px solid #ff9600;}
    </style>
