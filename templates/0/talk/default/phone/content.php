<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left save_name="<?php echo $module['module_save_name'];?>"  >
    ...
    $(document).ready(function(){
		$("#<?php echo $module['module_name'];?> .buttons a").each(function(index, element) {
            $(this).html('');
        });
		$("#<?php echo $module['module_name'];?> .buttons2 a").each(function(index, element) {
            $(this).html('');
        });
		$("#<?php echo $module['module_name'];?> .buttons").css('opacity',1);
		$("#<?php echo $module['module_name'];?> .buttons2").css('opacity',1);
		
		$("#comment_input_div_close").click(function(){$("#comment_input_div").css('display','none'); return false;});
		...
		$("#<?php echo $module['module_name'];?> .comment_button").click(function(){
			if(getCookie('cloud_nickname')==''){window.location.href='/index.php?index.login';}
				...
				$("#<?php echo $module['module_name'];?> #comment_input_div").css('display','block').css('left',10).css('top',position.top+30);
	...
	#<?php echo $module['module_name'];?>_html #comment_auth_img{ height:20px;}
	#<?php echo $module['module_name'];?>_html #authcode_img{ height:20px;}
	#<?php echo $module['module_name'];?>_html #comment_input{ width:40%; border:1px solid #ddd;}
	...
	#comment_input_div{  padding:0.5rem; border-radius:0.5rem; line-height:2rem;}
	    
    #<?php echo $module['module_name'];?>_html .title_div{   height:6.5rem; background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['text']?>; }
	#<?php echo $module['module_name'];?>_html .title_div div{ display:inline-block;} 
	#<?php echo $module['module_name'];?>_html .title_div .username{ display:inline-block; margin-top:0.5rem; margin-left:0.5rem;}
	...
	#<?php echo $module['module_name'];?>_html .title_div .title{ margin-left:0.5rem; display:inline-block;}
	...
	#<?php echo $module['module_name'];?>_html .content_div{ width:100%;}
	#<?php echo $module['module_name'];?>_html .content_div .buttons{  margin-top:2px;}
	...
	#<?php echo $module['module_name'];?>_html .content_div .comment_div .buttons2{ margin-right:1rem;}
	#<?php echo $module['module_name'];?>_html .content_div .comment_div{ padding-left:10px;  text-align:right; border-bottom:1px dotted #f1e8dc; padding-bottom:20px; margin-left:20px; margin-right:20px;}
   ...
   #<?php echo $module['module_name'];?>_html .content_div .comment_div .username:before{font: normal normal normal 1rem/1 FontAwesome; content:"\f007"; padding-right:2px;}
    ...
    #<?php echo $module['module_name'];?>_html .content_div{ border-bottom:1px solid #e3d1b9; padding-left:0.5rem;}
	...
	#<?php echo $module['module_name'];?>_html .content_div .content_content{}
	...
	#<?php echo $module['module_name'];?>_html #comment_input_div_close{ display: inline-block; width:2rem; cursor:pointer;}
	#<?php echo $module['module_name'];?>_html #comment_input_div_close:before{margin-right:8px; font: normal normal normal 1rem/1 FontAwesome; content:"\f00d";}
	
	#<?php echo $module['module_name'];?>_html .title_div .replay{ float:right; margin-right:40px; display:inline-block; margin-top:28px;   border-radius:5px; padding:5px;}
	...
	#<?php echo $module['module_name'];?>_html .m_hide:before{font: normal normal normal 1rem/1 FontAwesome; content:"\f070";}
	#<?php echo $module['module_name'];?>_html .m_show:before{font: normal normal normal 1rem/1 FontAwesome; content:"\f06e";}
	#<?php echo $module['module_name'];?>_html .del:before{font: normal normal normal 1rem/1 FontAwesome; content:"\f014";}
	#<?php echo $module['module_name'];?>_html .comment_button:before{font: normal normal normal 1rem/1 FontAwesome; content:"\f040";}

	#<?php echo $module['module_name'];?>_html .buttons{ opacity:0;}
	#<?php echo $module['module_name'];?>_html .buttons2{ opacity:0;}
    </style>
