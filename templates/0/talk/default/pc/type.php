<div id=<?php echo $module['module_name'];?> save_name="<?php echo $module['module_save_name'];?>"   class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
    ...
    #<?php echo $module['module_name'];?> .type_a{ display:inline-block; margin:40px; }
    ...
    #<?php echo $module['module_name'];?> .type_a .icon_div img{width:113px; box-shadow:1px 1px 8px 0px rgba(0,0,0,.3); border-radius:20px; border:2px solid #fff; margin:5px; background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; }
    #<?php echo $module['module_name'];?> .type_a .icon_div .name{width:100%; text-align:center; overflow:hidden; height:30px; line-height:30px;}
    ...
    #<?php echo $module['module_name'];?> .type_a .sum_div .day_title_sum{ line-height:34px;}
