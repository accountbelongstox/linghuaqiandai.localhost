...
#<?php echo $module['module_name'];?>_html .type a{  display:block; font-weight:normal;}
...
#<?php echo $module['module_name'];?>_html .type .page_type_deep_1 a{padding-left:25px; border-bottom:1px solid #f3f3f3; line-height:3.57rem;}
#<?php echo $module['module_name'];?>_html .type .page_type_deep_1 a:hover{  border-bottom:#F30 1px solid;}
