<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left save_name="<?php echo $module['module_save_name'];?>"  style="width:100%;" >
    <script>
    ...
    #<?php echo $module['module_name'];?> .page_list_div a{  line-height:3.57rem; display:inline-block;width:<?php echo $module['sub_module_width'];?>; overflow:hidden; text-align:left;  border-bottom:1px solid #e7e7e7;}
    #<?php echo $module['module_name'];?> .page_list_div a:hover{ border-bottom:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?> 1px solid;}
    ...
    #<?php echo $module['module_name'];?> .page_list_div .list_head{font-size:1.71rem; height:4.28rem; background-position:top; line-height:4.28rem;   font-weight:bold;background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['text']?>;}
