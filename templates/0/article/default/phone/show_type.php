...
$(document).ready(function(){
	...
	$("#<?php echo $module['module_name'];?> #article_type_"+get_param('type')).attr('class','current_type');
	...
	cloud=get_param('m');
	if(cloud=='article.show_article_list' && get_param('type')!=''){
		$("#<?php echo $module['module_name'];?> #article_type_"+get_param('type')).parent().css('display','block');	
		$("#<?php echo $module['module_name'];?> #article_type_"+get_param('type')).parent().parent().css('display','block');	
	}
