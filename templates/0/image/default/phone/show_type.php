...
<style>
#<?php echo $module['module_name'];?>{ width:<?php echo $module['module_width'];?>; height:<?php echo $module['module_height'];?>;display:inline-block;vertical-align:top; overflow:hidden; background:#fff; border:1px solid #e7e7e7;padding:0px;}
#<?php echo $module['module_name'];?>_html{ line-height:3.57rem;}
#<?php echo $module['module_name'];?>_html .type{}
#<?php echo $module['module_name'];?>_html .type .parent{font-size:1.2rem; height:3.5rem;line-height:3.5rem;  background-position:top;   padding-left:25px;  font-weight:bold;background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['text']?>;}
...
#<?php echo $module['module_name'];?>_html .type .image_type_deep_2{display:<?php echo $module['page_type_deep_2'];?>;}
#<?php echo $module['module_name'];?>_html .type .image_type_deep_3{display:<?php echo $module['page_type_deep_3'];?>;}
#<?php echo $module['module_name'];?>_html .type .image_type_deep_1 a{padding-left:25px; border-bottom:1px solid #f3f3f3;font-size:1.28rem; line-height:3.57rem;}
#<?php echo $module['module_name'];?>_html .type .image_type_deep_1 a:hover{  border-bottom:#F30 1px solid;}
#<?php echo $module['module_name'];?>_html .type .image_type_deep_2 a{ padding-left:65px;}
#<?php echo $module['module_name'];?>_html .type .image_type_deep_2 a:hover{}
#<?php echo $module['module_name'];?>_html .type .image_type_deep_3 a{ padding-left:105px;}
#<?php echo $module['module_name'];?>_html .type .image_type_deep_3 a:hover{}
</style>
