<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left save_name="<?php echo $module['module_save_name'];?>"   style="width:100%;">
    ...
    #<?php echo $module['module_name'];?> .thumbs_div a{ margin-bottom:1rem; margin-top:1.42rem;  margin-left:1%; margin-right:2%;  display:inline-block; vertical-align:top;  width:45%; overflow:hidden; text-align:center;   }
    ...
    #<?php echo $module['module_name'];?> .thumbs_div a .thumb_img{ vertical-align:middle;  height:8rem; border:1px solid #ddd; margin:0.5rem; margin-bottom:0px;}
    #<?php echo $module['module_name'];?> .thumbs_div a .thumb_img:hover{border:1px solid #e7e7e7; opacity:0.8;}
