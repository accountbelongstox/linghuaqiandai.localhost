<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left >
	...
	<style>
    #<?php echo $module['module_name'];?>_html{margin:30px; line-height:2rem;}
    #<?php echo $module['module_name'];?>_html .input_text{width:220px; height:30px; line-height:30px; border-radius:3px; margin-bottom:10px;}
