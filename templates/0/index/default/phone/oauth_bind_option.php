<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>">
<script>
 $(document).ready(function(){
	 ...
	 $("#<?php echo $module['module_name'];?> .skip").click(function(){
		...
		$("#<?php echo $module['module_name'];?>_html .skip").html('<span class=\'fa fa-spinner fa-spin\'>&nbsp;<?php echo self::$language['landing']?></span>');
...
#<?php echo $module['module_name'];?>_html .loading{margin-top:10px;}
    ...
    <div id="<?php echo $module['module_name'];?>_html">
        ...
        <div class=body>
            ...
            <a href=/index.php?cloud=index.reg_user&group_id=<?php echo $module['default_group_id']?>&oauth=1 class=new><?php echo self::$language['bind'];?><?php echo self::$language['new_account'];?></a>
            <a href=/index.php?cloud=index.login&oauth=1 class=old><?php echo self::$language['bind'];?><?php echo self::$language['existing_account'];?></a>
