<!---------------------------------------------------------------------------------------------slider_show_start-->
<div id=<?php echo $module['module_name'];?>  cloud-module="<?php echo $module['module_name'];?>" align="center"  style="display:inline-block;height:<?php echo $module['height']?>; "  cloud_slider=1>
	<script>
