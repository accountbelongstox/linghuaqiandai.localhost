<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left style="width:100%;">
<script>
...
<style>
    #<?php echo $module['module_name'];?>_html{ padding:10px; margin-left:25px; margin-right:25px;}
    #<?php echo $module['module_name'];?>_html div{ line-height:60px; vertical-align:top;}
    #<?php echo $module['module_name'];?>_html #next{ display:none;}
    #<?php echo $module['module_name'];?> .m_label{ display:inline-block; width:15%;  text-align:right; padding-right:10px;vertical-align:top;}
    #<?php echo $module['module_name'];?> .input_span input{ width:30%;}
    #<?php echo $module['module_name'];?> .input_span #content{ width:80%; height:100px;}
    #<?php echo $module['module_name'];?> .input_span #authcode{width:100px;}
    #<?php echo $module['module_name'];?>_html #authcode_img{ height:30px;}
    ...
    #<?php echo $module['module_name'];?>_html .feedback_icon:before{font: normal normal normal 3rem/1 FontAwesome; content:"\f1d7";line-height:6.57rem; opacity:0.8;color:#A88B6C;}
</style>
