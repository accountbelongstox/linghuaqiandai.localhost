<div id=<?php echo $module['module_name'];?>  class="portlet light" cloud-module="<?php echo $module['module_name'];?>" align=left save_name="<?php echo $module['module_save_name'];?>"  >
    ...
    #<?php echo $module['module_name'];?>_html .msg_div{ margin:20px; border-bottom:1px solid #ccc;;  padding:10px; margin-top:50px; padding-bottom:50px;}
    ...
    #<?php echo $module['module_name'];?>_html .msg_div .answer_div{ margin-left:120px; margin-right:50px;}	
    #<?php echo $module['module_name'];?>_html .msg_div .content_div .v{ display:inline-block;   border-radius:0.5rem; padding:
	1rem;  margin-bottom:2rem;background:<?php echo $_POST['cloud_user_color_set']['nv_2_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_2_hover']['text']?>;}
    #<?php echo $module['module_name'];?>_html .msg_div .answer_div .v{ display:inline-block;   border-radius:0.5rem;padding:
	1rem;background:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>; color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['text']?>; }	
    #<?php echo $module['module_name'];?>_html .msg_div .content_div:before{font: normal normal normal 2rem/1 FontAwesome; content:"\f0d8"; padding-left:0.5rem;  height:1.2rem; display:block; overflow:hidden;color:<?php echo $_POST['cloud_user_color_set']['nv_2_hover']['background']?>; }
    #<?php echo $module['module_name'];?>_html .msg_div .answer_div:after{font: normal normal normal 2rem/1 FontAwesome; content:"\f0d7"; padding-right:1rem;  height:0.5rem; line-height:0.3rem; display:block; overflow:hidden;color:<?php echo $_POST['cloud_user_color_set']['nv_1_hover']['background']?>;}
