...
#<?php echo $module['module_name'];?>_html .swiper-wrapper div a{ display:inline-block; vertical-align:top; text-align:center; width:120px; margin:23px;  }
#<?php echo $module['module_name'];?>_html .swiper-wrapper div a:hover{ opacity:0.5;}
