...
#<?php echo $module['module_name'];?>_html .swiper-wrapper div a{ display:inline-block; vertical-align:top; text-align:center; width:22%; margin:1.4%;}
...
#<?php echo $module['module_name'];?>_html .swiper-wrapper div a .name{ font-size:1rem; padding:0.3rem; padding-bottom:0.7rem; padding-top:0px; line-height:2rem; height:2rem; overflow:hidden; }




#<?php echo $module['module_name'];?> .swiper-slide{ padding:0px; margin:0px; overflow:hidden;}
