...
$(document).ready(function(){
  ...
  var mySwiper = new Swiper('.swiper-container',{
	...
	$(".swiper-container").height(($("#<?php echo $module['module_name'];?> .swiper-container a").width()+20)*3);
...
#<?php echo $module['module_name'];?>_html{min-height:300px;}
...
#<?php echo $module['module_name'];?>_html .swiper-wrapper div a{ display:inline-block; vertical-align:top; text-align:center; width:30%; margin:1.4%;    border-radius:8px;}
...
#<?php echo $module['module_name'];?>_html .swiper-wrapper div a .name{ font-size:40px; padding:5px; padding-bottom:10px; padding-top:0px; line-height:60px; height:60px; overflow:hidden; }
