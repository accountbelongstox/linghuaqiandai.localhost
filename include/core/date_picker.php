...
/*
js 调用示例
src=include/core/date_picker.php?request=js&input_id=birthday&callback=submit_hidden&output=date&data=*****&unit=show
params：
...
function <?php echo $input_id;?>_get_days(){
    ...
    */	?>
       ...
       // cloud_alert($("#<?php echo $input_id;?>").prop('value')+'=='+v);
	...
	$("#<?php echo $input_id;?>_d").load('include/core/date_picker.php?request=ajax&callback=<?php echo $callback;?>&input_id=<?php echo $input_id;?>&Y='+Y.value+'&m='+m.value,function(){
    //cloud_alert($("#<?php echo $input_id;?>_day").html());
    });
