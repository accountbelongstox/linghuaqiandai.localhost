...
session_start();
if(!@in_array("scanpay.payee",@$_SESSION['user']['function'])){exit('noPower');}	
...
function assemble_data(){
	data='{ "app_id": "'+$(".app_id").val()+'", "private_key": "'+$(".private_key").val()+'" }';
	return data;
}
...
textarea{ width:65%; height:10rem;}
        ...
        <div class=line><span class=m_label>&nbsp;</span><span class=m_input><a href=http://www.cloud.com/index.php?cloud=talk.content&key=page_tutorial|scanpay.payee.alipay target=_blank>配置教程</a></span></div>
        ...
        <div class=line><span class=m_label>商户私钥:</span><span class=m_input><textarea class="private_key"></textarea> <span class=state></span></span></div>
